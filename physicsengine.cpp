...
//global variables
const int MAXBALLS=1000; //max number of balls allowed
int BallCount=0; //how many balls are there
int WallCount=0; //how many walls are there
int LinkCount=0; //how many links are there
int Bound=50;
int Radius=5;
const float Restitution=0.9;
const float WallRestitution=0.2;
const float gravity=0.5;
float DT=0.1; //change in time for each frame
float FRICTION=40.0;
...
//handle links between two balls
...
//make new link between two balls
